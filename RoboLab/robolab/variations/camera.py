...
@configclass
class PolarisDefaultCameraCfg:
    """Camera matching the default PolaRiS DROID-MoveLatteCup external_cam position.

    Positioned close to and slightly right of the robot base (-0.33 m in Y),
    at 0.48 m height, looking forward-and-down toward the workspace.
    Use this for sim-to-sim transfer comparisons with the PolaRiS environment.
    """
